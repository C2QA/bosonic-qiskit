...
def test_cat_state_wigner_plot(capsys):
    with capsys.disabled():
        ...
        state, result, accumulated_counts, fock_counts = c2qa.util.simulate(circuit, conditional_state_vector=True)
...
def test_wigner_mle(capsys):
    with capsys.disabled():
        ...
        state, result, accumulated_counts, fock_counts = c2qa.util.simulate(circuit, per_shot_state_vector=True)
