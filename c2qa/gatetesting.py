...
def initi(qmr, diffstallmodes):
    circuit.cv_initialize(diffstallmodes[0], qmr[0])
    circuit.cv_initialize(diffstallmodes[1], qmr[1])

def differentModeInitialisation(qmr, numberofmodes, qbinist, samestallmodes):
    diffstallmodes = [0, 0]
    initi(qmr, diffstallmodes)
...
def differentThetaInitialisation(qmr, numberofmodes, qbinist, samestallmodes, diffstallmodes):
    print("pi")
    initi(qmr, diffstallmodes)
